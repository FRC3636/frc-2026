...
object Shooter {
    object Turret : Subsystem{
        ...
        fun alignToHub(offset: Angle = 0.0.degrees) {
            val camError = (turretLimelight.getEntry("tx").getDouble(0.0).degrees - offset).inRadians()
...
//        }
        ...
        fun turnToTargetAngle(angle: Angle): Command =
            run {
