...
object TwoScore: Auto {
    ...
    private enum class Targets(val target: APTargetWithTolerance) {
        Target1(APTargetWithTolerance(Pose2d(2.7136747875808314.meters, 6.008694768709806.meters, Rotation2d((-0.7500147072732971).radians))).withTolerance(10.meters)),
        Target2(APTargetWithTolerance(Pose2d(3.8616252017874615.meters, 7.413649006992547.meters, Rotation2d((-0.75).radians)))),
        Target3(APTargetWithTolerance(Pose2d(7.0.meters, 7.208045947731659.meters, Rotation2d(1.98448554007376.radians)))),
//        Target4(APTarget(Pose2d(7.545346680211723.meters, 4.792210001416213.meters, Rotation2d(1.6926387638148142.radians)))),
        Target4(APTargetWithTolerance(Pose2d(7.545346680211723.meters, 3.5.meters, Rotation2d(1.6926387638148142.radians)))),
...
//    )
    ...
    enum class Targets(val target: APTargetWithTolerance) {
        Target1(APTargetWithTolerance(Pose2d(7.0313390320595.meters, 3.335854998318249.meters, Rotation2d(2.8368720828252267.radians)))),
        Target2(APTargetWithTolerance(Pose2d(7.014205443787759.meters, 4.4152710594379165.meters, Rotation2d(-3.1262092518091977.radians))))
    }
