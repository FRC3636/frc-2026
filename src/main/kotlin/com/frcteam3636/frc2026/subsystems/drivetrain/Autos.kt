...
object TestAuto: Auto {
    ...
    fun testAutoPath(path: Array<APTarget>): Command = Commands.sequence(
        Drivetrain.alignWithAutopilot(path[0]),
        Drivetrain.alignWithAutopilot(path[1])
    )
    ...
    override fun getPath(drivetrain: Drivetrain, flipH: Boolean, flipV: Boolean): Command =
        testAutoPath (
            flipPath(arrayOf(Targets.Target1.target, Targets.Target2.target), flipH, flipV)
        )
